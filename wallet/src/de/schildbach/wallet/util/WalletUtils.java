...
public class WalletUtils {
    ...
    private static Script inheritanceScriptWithCSV(byte[] ownerPubKey, byte[] heirPubKey, int blocks) {
    ...
    private static byte[] encodeBip68Sequence(long blocks) {
        ...
        Collections.reverse(Arrays.asList(sequenceBytes));
